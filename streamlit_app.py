...
# conf.get_default().auth_token = "2zAMb3yKpW8NdulWVpi6qJXDqGe_3tSGP4dhdDhhmWLHhqWU3"  # ← Replace this
# 
# # Streamlit UI setup
# st.set_page_config(page_title="😂 Mood Swing Machine", page_icon="🎭")
# 
...
#     st.success(f"🎉 Surprise! You're now feeling {surprise_mood}")
